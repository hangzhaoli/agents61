...
/** Long public tutorial. Research workflow, not a profit promise and not an order ticket. */
export const EARN_WITH_AGENTS61: BlogPost = {
  slug: 'how-to-use-agents61-to-make-money',
  ...
  tags: [
    ...
    'paper trading',
    'US stock research',
    'options wheel research',
  ],
  keyTakeaway:
    'Agents61 does not pay you and does not send orders. You make money, if you make it, at a broker you already use, after a committee has inverted the idea and a paper book has shown the drawdown you would have to sit through.',
  relatedSlugs: [
  ...
  faqs: [
    ...
    {
      question: 'Can I treat the backtest return as expected profit?',
      answer:
    ...
    {
      question: 'Which module should a newcomer open first?',
      answer:
    ...
    {
      question: 'Are the options prices real quotes?',
      answer:
    ...
    {
      question: 'Is the crypto perpetual a live Binance account?',
      answer:
